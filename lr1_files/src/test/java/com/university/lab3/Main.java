...
public class Main {
    public static void main(String[] args) {
        ...
        repo.addCar(new Car("Москвич", "C", 1200, new Driver("Иван Иванов", 3), new Engine(100, "Завод СССР")));
        repo.addCar(new Car("Ford Focus", "B", 1400, new Driver("Петр Петров", 10), new Engine(150, "Ford")));
        repo.addCar(new Car("Жигули", "C", 1300, new Driver("Сергей Сергеев", 6), new Engine(120, "Завод СССР")));

        printExperiencedDrivers(repo.getAllCars());
        printSovietCars(repo.getAllCars());
    }
